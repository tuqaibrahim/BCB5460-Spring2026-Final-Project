...
modes = {
    "M_noPrimary": Path("counts/featureCounts_gencode_v37_noPrimary/gencode_v37_featureCounts_s0_M_noPrimary.txt"),
    "M_fraction_noPrimary": Path("counts/featureCounts_gencode_v37_noPrimary/gencode_v37_featureCounts_s0_M_fraction_noPrimary.txt"),
    "M_O_noPrimary": Path("counts/featureCounts_gencode_v37_noPrimary/gencode_v37_featureCounts_s0_M_O_noPrimary.txt"),
    "M_O_fraction_noPrimary": Path("counts/featureCounts_gencode_v37_noPrimary/gencode_v37_featureCounts_s0_M_O_fraction_noPrimary.txt"),
}
...
for mode, fc_file in modes.items():
    ...
    check_genes = [
        ...
        "LINC00324", "AC024651.2", "LINC02049"
    ]
